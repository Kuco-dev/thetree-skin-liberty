                ...
                <div id="bottom" class="liberty-footer">
                    ...
                    <ul class="footer-icons">
                        <li class="footer-poweredbyico">
                            <a href="//github.com/Kuco-dev/thetree-skin-liberty/tree/jeoriga-liberty" target="_blank">Liberty</a> | <a href="//github.com/wjdgustn/thetree" target="_blank">the tree</a>
                        </li>
                    </ul>
                </div>
